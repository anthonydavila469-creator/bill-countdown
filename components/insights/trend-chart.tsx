  ...
  if (trendData.length === 0) {
    return (
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-violet-500/60 via-violet-500/60 to-teal-500/30" />

        <div className="relative">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-2.5 rounded-xl bg-gradient-to-br from-violet-500/20 to-violet-500/20 border border-violet-500/30">
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            <div className="p-3 rounded-full bg-violet-500/10 border border-violet-500/20 mb-4">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
              ...
              <Area
                ...
                dot={{ fill: '#8B5CF6', strokeWidth: 2, stroke: '#18181b', r: 4 }}
                activeDot={{
                  r: 6,
                  fill: '#8B5CF6',
                  stroke: '#fff',
