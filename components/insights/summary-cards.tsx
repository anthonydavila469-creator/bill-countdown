...
export function SummaryCards({
  ...
  const percentChange = previousTotal > 0 ? ((difference / previousTotal) * 100).toFixed(0) : 0;
          ...
          {isFirstMonth ? (
            ...
            <>
              ...
              <p className="text-sm text-zinc-400">
                ...
                {isDecrease && `${Math.abs(Number(percentChange))}% less than last month`}
