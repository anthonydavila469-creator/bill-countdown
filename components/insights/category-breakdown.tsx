...
const categoryColors: Record<BillCategory | 'other', { bar: string; text: string; bg: string }> = {
  ...
  housing: { bar: 'from-amber-500 to-amber-400', text: 'text-amber-400', bg: 'bg-amber-500/10' },
  utilities: { bar: 'from-yellow-500 to-lime-400', text: 'text-yellow-400', bg: 'bg-yellow-500/10' },
  subscription: { bar: 'from-amber-500 to-amber-400', text: 'text-amber-400', bg: 'bg-amber-500/10' },
  insurance: { bar: 'from-orange-500 to-orange-400', text: 'text-orange-400', bg: 'bg-orange-500/10' },
  phone: { bar: 'from-pink-500 to-rose-400', text: 'text-pink-400', bg: 'bg-pink-500/10' },
  internet: { bar: 'from-orange-500 to-amber-400', text: 'text-orange-400', bg: 'bg-orange-500/10' },
...
export function CategoryBreakdown({ breakdown, bills }: CategoryBreakdownProps) {
  ...
  return (
    ...
    >
      ...
      {/* Decorative gradient */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-amber-500/50 via-orange-500/50 to-pink-500/50" />
