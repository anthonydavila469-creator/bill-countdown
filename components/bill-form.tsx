    ...
    <form onSubmit={handleSubmit} className="space-y-6 touch-manipulation">
      ...
      <div className={cn(
        ...
        formData.is_recurring
          ? "bg-gradient-to-br from-amber-500/10 via-violet-500/5 to-violet-500/10 border border-amber-500/20 overflow-visible"
          ...
          >
            <div className="flex items-center gap-3">
              <div className={cn(
                ...
                formData.is_recurring
                  ? "bg-gradient-to-br from-amber-500 to-violet-600 shadow-lg shadow-amber-500/25"
            ...
            <div className={cn(
              ...
              formData.is_recurring
                ? "bg-gradient-to-r from-amber-500 to-violet-500 shadow-lg shadow-amber-500/30"
                : "bg-white/10"
            )}>
              <div className={cn(
                ...
                {recurrenceOptions.map((option) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {!isSelected && (
                        <div className="absolute inset-0 bg-gradient-to-br from-amber-500/0 to-violet-500/0 group-hover/pill:from-amber-500/10 group-hover/pill:to-violet-500/10 transition-all duration-300" />
                      )}
