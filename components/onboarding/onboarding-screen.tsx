      ...
      <div className="space-y-3">
        ...
        <button
          ...
          className={cn(
            ...
            isPro
              ? 'bg-gradient-to-br from-violet-500/15 to-violet-400/15 border border-violet-500/30 hover:border-violet-500/50 hover:from-violet-500/20 hover:to-violet-400/20'
              : 'bg-gradient-to-br from-violet-500/10 to-violet-400/10 border border-violet-500/20 hover:border-violet-500/40'
          )}
        >
          <div className="flex items-center gap-4">
            <div className="p-3 rounded-xl bg-gradient-to-br from-violet-500 to-violet-400">
            ...
            <div className="flex-1 text-left">
              <div className="flex items-center gap-2 mb-1">
                ...
                {!isPro && canSyncGmail && (
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-violet-400/20 text-violet-300 font-medium">
                    1 FREE
                  </span>
                )}
                {!canSyncGmail && (
                  <span className="flex items-center gap-1 text-[10px] px-1.5 py-0.5 rounded bg-violet-400/20 text-violet-300 font-medium">
        ...
        <button
          ...
          className={cn(
            ...
            isPro
              ...
              : 'bg-gradient-to-br from-violet-400/10 to-violet-500/10 border border-violet-400/20 hover:border-violet-400/40 hover:from-violet-400/15 hover:to-violet-500/15'
          )}
        >
          <div className="flex items-center gap-4">
            <div className={cn(
              "p-3 rounded-xl",
              isPro ? "bg-white/10" : "bg-gradient-to-br from-violet-400 to-violet-500"
            )}>
            ...
            <ArrowRight className={cn(
              ...
              isPro ? "text-white/40" : "text-violet-300"
            )} />
          </div>
        </button>
    ...
    <div className="animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <button
        ...
        className={cn(
          ...
          selectedIds.size > 0
            ? 'bg-gradient-to-r from-violet-400 to-violet-500 text-white hover:opacity-90'
