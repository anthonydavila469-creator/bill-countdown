    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex justify-center mb-8">
        <div className="relative">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-500 to-violet-500 flex items-center justify-center">
    ...
    <div className="animate-in fade-in slide-in-from-right-4 duration-300">
      ...
      <button
        ...
        className={cn(
          ...
          selectedIds.size > 0
            ? 'bg-gradient-to-r from-violet-500 to-violet-500 text-white hover:opacity-90'
