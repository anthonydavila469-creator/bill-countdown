          ...
          <div className="relative p-8">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-violet-400 to-violet-400 rounded-2xl blur-xl opacity-50" />
                <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-500 to-violet-500 flex items-center justify-center">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              ...
              <div className="p-3 rounded-xl bg-violet-500/10 border border-violet-500/20 text-center relative">
