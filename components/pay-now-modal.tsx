...
const urgencyGradients = {
  ...
  urgent: 'from-violet-500/90 via-amber-500/80 to-yellow-500/70',
                ...
                <div className="flex justify-center">
                  {isAutopay ? (
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-amber-500/20 to-violet-500/20 border border-amber-500/30 shadow-lg">
