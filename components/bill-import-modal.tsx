                                  ...
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    {bill.editingAmount ? (
                                      <input
                                        ...
                                        className="w-20 px-2 py-0.5 bg-white/10 border border-white/20 rounded text-white text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
                                        autoFocus
                                      />
                                    ) : (
                                      <button
                                  ...
                                  <div className="flex items-center gap-1.5">
                                    ...
                                    {bill.editingDate ? (
                                      <input
                                        ...
                                        className="px-2 py-0.5 bg-white/10 border border-white/20 rounded text-white text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
                                        autoFocus
                                      />
                                    ) : (
                                      <button
