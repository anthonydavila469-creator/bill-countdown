      ...
      <aside className="fixed left-0 top-0 bottom-0 w-64 bg-gradient-to-b from-[#0c0c10] to-[#09090d] border-r border-white/[0.06] hidden lg:flex flex-col">
          ...
          <ul className="space-y-1">
            <li>
              ...
              >
                ...
                <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 rounded-r-full bg-gradient-to-b from-violet-400 to-violet-400 shadow-[0_0_8px_rgba(249,115,22,0.5)]" />
                <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-gradient-to-br from-violet-500/20 to-violet-400/20 border border-white/[0.08]">
            ...
            <li>
              ...
              >
                <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-white/[0.03] group-hover:bg-white/[0.06] border border-transparent group-hover:border-white/[0.06] transition-all duration-200">
                  <Lightbulb className="w-4 h-4 group-hover:text-violet-300 transition-colors duration-200" />
                </div>
        ...
        {!isGmailConnected && (
          <div className="p-4 border-t border-white/[0.06]">
            <div className="relative p-4 rounded-xl overflow-hidden bg-gradient-to-br from-violet-500/10 via-violet-400/5 to-violet-500/10 border border-violet-500/20">
              {/* Decorative glow */}
              ...
              <div className="relative">
                ...
                <Link
                  href="/dashboard/settings"
                  className="block w-full px-3 py-2 text-sm font-semibold bg-gradient-to-r from-violet-500/20 to-violet-400/20 hover:from-violet-500/30 hover:to-violet-400/30 border border-white/10 hover:border-white/20 rounded-lg transition-all duration-200 text-white text-center"
                >
                  Connect Gmail
                </Link>
              </div>
        ...
        <div className="p-6">
          ...
          {dashboardLayout.showStatsBar && (
            <div className="grid grid-cols-3 gap-3 mb-8">
              <div className="relative p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-violet-500/[0.08] to-white/[0.01] border border-violet-500/20 overflow-hidden group hover:border-violet-500/30 transition-all duration-300 flex flex-col items-center justify-center text-center">
                ...
                <p className="text-3xl sm:text-4xl font-black text-violet-400 drop-shadow-[0_0_10px_rgba(251,146,60,0.3)]">
                  {billsDueSoon.length}
                </p>
              </div>
          ...
          <div className="mb-6">
            ...
            {selectedBillIds.size > 0 && (
              <div className="flex items-center justify-between gap-4 mb-4 p-3 rounded-xl bg-gradient-to-r from-violet-500/10 to-violet-400/10 border border-violet-500/20 animate-in fade-in slide-in-from-top-2">
