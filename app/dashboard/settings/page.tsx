        ...
        <div className="p-6 max-w-2xl mx-auto space-y-10">
                ...
                {!isGmailConnected ? (
                  ...
                  <>
                    ...
                    <div className="flex gap-2 sm:gap-3">
                      ...
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-violet-500 to-violet-400" />
                        <div className="absolute inset-0 bg-gradient-to-r from-violet-400 to-violet-300 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                    ...
                    <div className="mt-4 pt-4 border-t border-white/[0.06]">
                      {!showForceRescanConfirm ? (
                        ...
                        <div className="p-4 rounded-xl bg-violet-400/[0.05] border border-violet-400/20">
                          <div className="flex items-start gap-3 mb-3">
                            <AlertTriangle className="w-4 h-4 text-violet-300 flex-shrink-0 mt-0.5" />
                            <div>
                              <p className="text-sm text-violet-200 font-medium">Force Rescan</p>
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              disabled={isForceRescanning}
                              className="flex items-center gap-2 px-4 py-2 bg-violet-400/20 hover:bg-violet-400/30 border border-violet-400/30 rounded-lg text-sm font-medium text-violet-200 transition-colors"
                            >
                              {isForceRescanning ? (
                                <>
          ...
          <section>
            ...
            >
              ...
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-violet-500/5 to-violet-400/5 rounded-full blur-2xl" />
              ...
              <div className="relative flex items-center justify-between mb-6">
                ...
                <div className={cn(
                  ...
                  <div className={cn(
                    ...
                    isPro ? "bg-violet-300" : "bg-violet-400"
                  )} />
                  <span className={cn(
                    "text-xs font-medium uppercase tracking-wider",
                    isPro ? "text-violet-300" : "text-zinc-400"
                  )}>
