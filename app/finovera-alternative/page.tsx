...
import { ArrowRight, Check, X, Shield, Zap, Clock, Camera } from 'lucide-react';
          ...
          {[
            {
              ...
              desc: 'Use Quick Add or snap a photo — Netflix, rent, insurance, utilities. Anything that sends you a bill.',
            },
            {
              icon: Zap,
              title: 'AI Photo Scan',
