      ...
      <section className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8">
          ...
          <p className="text-zinc-300 text-lg leading-relaxed">
            Duezo costs <strong className="text-violet-400">67% less than YNAB</strong>, takes 2 minutes to set up (vs hours for YNAB), and does the one thing most people actually need: making sure bills get paid on time.
          </p>
        </div>
      </section>
