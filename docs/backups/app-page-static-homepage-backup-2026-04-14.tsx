          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-[720px] mx-auto">
            ...
            <div className="relative p-8 rounded-[24px] border border-violet-500/[0.25] bg-gradient-to-b from-violet-500/[0.06] to-white/[0.015]">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full text-center py-3 px-6 text-[15px] font-semibold rounded-full bg-white hover:bg-zinc-100 transition-colors shadow-[0_0_24px_rgba(139,92,246,0.2)]"
                style={{ color: '#09090b' }}
              >
                <span style={{ color: '#09090b' }}>Start Free Trial</span>
              </a>
            </div>
          </div>
      ...
      <section className="relative py-32 md:py-40 border-t border-white/[0.04] overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto px-6 sm:px-10 text-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center gap-3 px-12 py-5 text-[17px] font-bold bg-white rounded-full hover:bg-zinc-100 transition-all shadow-[0_0_70px_rgba(139,92,246,0.35)] hover:shadow-[0_0_90px_rgba(139,92,246,0.45)]"
            style={{ color: '#09090b' }}
          >
            <Apple className="w-5 h-5" style={{ color: '#09090b' }} />
            <span style={{ color: '#09090b' }}>Download Free for iPhone</span>
